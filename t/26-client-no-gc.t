...

{
    ...
    my $client = APNIC::RPKI::Erik::Client->new($otd, no_gc => 1);
    eval {
    ...
    my @new_files = sort `find $otd -type f`;
    is_deeply(\@new_files, \@files,
        'Files unavailable locally left in place correctly');
}
